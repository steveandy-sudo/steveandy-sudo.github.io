...
for (const file of htmlFiles) {
  ...
  if (document.documentElement.lang !== 'en') errors.push(`${route}: incorrect document language`);
  if (route.startsWith('/ko/') || document.querySelector('.language-link, a[href^="/ko/"]')) errors.push(`${route}: obsolete Korean page or language link`);
